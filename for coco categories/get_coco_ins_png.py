...
def batch_get_mask():
    txt_path = '/home/yanglu/Database/MSCOCO/MSCOCO_API/ym/coco/PythonAPI/scripts/code/coco_81_train.txt'
    #txt_path = '/home/yanglu/Database/MSCOCO/MSCOCO_API/ym/coco/PythonAPI/scripts/code/coco_81_val.txt'
    coco_train_list = []
    ...
    for idx in coco_train_list:
        ...
        cv2.imwrite('/home/yanglu/Database/MSCOCO/MSCOCO_API/ym/coco/PythonAPI/scripts/code/coco_81_ins/train2014/' + idx +'.png',_mask) #修改文件夹名称
        # coco_81_list.append(idx)
    # print len(coco_81_list)
    # f2 = open('./coco_81_seg/coco_81_val.txt', 'w')
    # f2.write("\n".join(coco_81_list))
