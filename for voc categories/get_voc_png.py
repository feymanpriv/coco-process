...
def batch_get_mask():
    ...
    for idx in coco_train_list:
        ...
        if labels:
            ...
            cv2.imwrite('/home/yanglu/Database/MSCOCO/MSCOCO_API/ym/coco/PythonAPI/scripts/code/coco_21_seg/train2014/' + idx + '.png',_mask)  #修改文件名
            coco_21_list.append(idx)

    f2 = open('./coco_21_seg/coco_21_train.txt', 'w')  #修改文件名
    f2.write("\n".join(coco_21_list))

def get_mask(img_height,img_width,npoints, labels):
